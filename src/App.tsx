...
const CONFIG = {
  ...
  counts: {
    foliage: 15000,
    ornaments: 18,   // number of polaroid photos
    elements: 50,    // 圣诞元素数量
    lights: 800       // 彩灯数量
  },
...
const PhotoOrnaments = ({ state, onPhotoClick }: { state: 'CHAOS' | 'FORMED', onPhotoClick: (index: number) => void }) => {
...
const Experience = ({ sceneState, rotationSpeed, onPhotoClick }: { sceneState: 'CHAOS' | 'FORMED', rotationSpeed: number, onPhotoClick: (index: number) => void }) => {
    ...
    <div style={{ width: '100vw', height: '100vh', backgroundColor: '#000', position: 'relative', overflow: 'hidden' }}>
      <div style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, zIndex: 1 }}>
        <Canvas dpr={[1, 2]} gl={{ toneMapping: THREE.ReinhardToneMapping }} shadows>
            <Experience sceneState={sceneState} rotationSpeed={rotationSpeed} onPhotoClick={setSelectedPhoto} />
        </Canvas>
      </div>
      ...
      <div style={{ 
        ...
        <p style={{
          ...
          Chúc Smol của anh có một giáng sinh an lành!
        </p>
      </div>

      {/* UI - Stats Bottom left */}
      {debugMode && (
      ...
      {selectedPhoto !== null && (
        <div 
          style={{
            ...
            animation: isModalClosing ? 'none' : 'fadeIn 0.3s ease-in-out'
          }}
        ...
        >
          <div style={{
            ...
            alignItems: 'center',
            transform: isModalClosing ? 'scale(0.9)' : 'scale(1)',
            opacity: isModalClosing ? 0 : 1,
            transition: 'all 0.3s ease-in-out',
            animation: isModalClosing ? 'none' : 'scaleIn 0.3s ease-in-out'
          }}>
            <img 
